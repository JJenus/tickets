<script type="text/javascript" setup>
	...
	// import "/assets/js/core/moment.js";
	...
	function makeid(lent) {
		...
		return result + "-" + n.charAt(Math.floor(Math.random() * n.length));
	}
	...
	$(function () {
		...
		$(".edit").click(function () {
			...
			if (edit.hasClass("money")) {
				var odd1 = $("#odd1").text();
				var o1 =
					parseFloat(odd1.split("/")[0]) /
					parseFloat(odd1.split("/")[1]);

				var odd2 = $("#odd2").text();
				var o2 =
					parseFloat(odd2.split("/")[0]) /
					parseFloat(odd2.split("/")[1]);
		...
		function retrieve() {
			if (localStorage.getItem("Williamhill_pro") !== null) {
				var stored = JSON.parse(
					localStorage.getItem("Williamhill_pro")
				);
		...
		<table class="customers">
			<tr class="">
				<td colspan="12">
					<div class="bg-dark msize bold" align="center">
						<span>385344</span>
						<span style="margin-left: 10px">WATFORD</span>
					</div>
				</td>
			</tr>
			...
			<tr class="bold msize">
				<td colspan="4" class="pad">
					<span @click="cal()" class="edit" id="code"
						>HRO8-8LTG-G3X4-7X</span
					>
				</td>
				<td colspan="4" id="date" class="edit center pad">
					12/03/2021
				</td>
				<td colspan="4" id="time" class="edit right pad" style="">
					99:23 AM
				</td>
			</tr>
			...
			<tr>
				<td colspan="12" class="edit" id="t1">21/08/2018, 19:45 PM</td>
			</tr>
			<tr class="">
				<td colspan="11">
					Correct Score - <span id="lig11" class="edit"
						>Krasonder/Atlanta</span
					>
					<span id="cs1" class="edit ms-2">2:0</span>
				</td>
			...
			<tr>
				<td colspan="12" class="edit" id="t1">21/08/2018, 11:45 AM</td>
			</tr>
			<tr class="">
				<td colspan="11">
					Correct Score - <span id="lig22" class="edit"
						>Krasonder/Atlanta</span
					>
					<span id="cs2" class="edit ms-2">2:0</span>
				</td>
			...
			<tr>
				...
				<th colspan="4" id="totalodd" class="right money edit">
					130.00
				</th>
			</tr>
			...
			<tr>
				<th class="" colspan="8">Max Return:</th>
			...
			<tr class="">
				<td align="center" colspan="12" style="padding-top: 20px">
					<div class="border-solid">Good luck!</div>
					<div
						colspan="8"
						style="
							text-align: center;
					...
					>
						<span
							>By takeover of this betslip the General Terms and </span
						><br />
						<span
							>conditions of William Hill become valid. Please
							gamble </span
						><br />
