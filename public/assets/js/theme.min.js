setTimeout(function () {
	...
	!(function () {
		...
		null !== (e = document.querySelector('[data-bs-toggle="mode"]')) &&
						...
						var t = n[e].querySelector(".range-slider-ui"),
							...
							e = {
								dataStartMin: parseInt(
									n[e].dataset.startMin,
									10
								),
								dataStartMax: parseInt(
									n[e].dataset.startMax,
									10
								),
			...
			document
				.querySelectorAll(".animation-on-hover")
				.forEach(function (e) {
					e.addEventListener("mouseover", function () {
						e.querySelectorAll("lottie-player").forEach(function (
							e
						) {
						...
						e.addEventListener("mouseleave", function () {
							e.querySelectorAll("lottie-player").forEach(
								function (e) {
									e.setDirection(-1), e.play();
								}
							);
